...
export const exercises = {
  ...
  detail: {
    ...
    equipmentTitle: 'Оборудование по залам',
    equipmentDescription:
      'Привяжите физическое оборудование, на котором выполняется это упражнение. При необходимости выберите один предпочтительный тренажёр для каждого зала.',
    noGyms: 'Залы пока не настроены.',
    noPhysicalEquipment: 'В залах пока не добавлено физическое оборудование.',
    gymHasNoEquipment: 'В этом зале пока нет физического оборудования.',
    incompatible: 'Несовместимо',
    linkEquipmentAria: 'Использовать {equipment} для этого упражнения в зале {gym}',
    preferredEquipmentAria: 'Сделать {equipment} предпочтительным в зале {gym}',
    preferred: 'Предпочтительное',
    makePreferred: 'Выбрать основным',
    equipmentSaved: 'Оборудование упражнения обновлено.',
