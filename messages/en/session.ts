export const session = {
  ...
  editableSets: {
    ...
    weightEditor: {
      ...
      title: 'Edit weights',
      scopeDescription: 'Choose where these available weights should apply.',
      allBarbell: 'All barbell exercises in this gym',
      allDumbbell: 'All dumbbell exercises in this gym',
      thisExercise: 'This exercise only',
      cancel: 'Cancel',
      allScope: 'All exercises of this equipment type',
      exerciseScope: 'This exercise only',
      equipment: {
        BARBELL: 'Barbell',
        DUMBBELL: 'Dumbbells',
        MACHINE: 'Machine',
      ...
      addIndividual: 'Add one weight',
      useGymDefaults: 'Use gym defaults',
      save: 'Save',
      saving: 'Saving...',
      saved: 'Available weights updated.',
      saveError: 'Could not update available weights.',
      tooManyWeights: 'The ranges contain more than 200 weights. Split or shorten them.',
    },
  },
  previousSession: {
  ...
  exerciseMenu: {
    ...
    saved: 'Exercise targets updated.',
    saveError: 'Could not update the exercise.',
    setsValue: '{count, plural, one {# set} other {# sets}}',
    repsValue: '{count, plural, one {# rep} other {# reps}}',
    repsRange: '{min}-{max} reps',
    dropSets: 'Drop sets',
    dropSetsValue: '{count, plural, =0 {No drop sets} one {# drop set} other {# drop sets}}',
    supersets: 'Supersets',
    linked: 'Linked',
    addNote: 'Add note',
    editNote: 'Edit note',
    ...
    repsMax: 'Maximum',
    save: 'Save',
    dissolveSuperset: 'Dissolve this superset',
    linkPrevious: 'Link with previous: {name}',
    linkNext: 'Link with next: {name}',
    combinePrevious: 'Combine with previous: {name}',
    combineNext: 'Combine with next: {name}',
    noNeighbors: 'There is no neighboring exercise to link.',
    supersetLinked: 'Superset updated.',
    supersetDissolved: 'Superset dissolved.',
    supersetError: 'Could not update the superset.',
    note: 'Exercise note',
    notePlaceholder: 'Technique cue, pain, or a note from your coach',
