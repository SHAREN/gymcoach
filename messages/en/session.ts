export const session = {
  ...
  exerciseActions: {
    open: 'Open exercise actions',
    actions: 'Exercise actions',
    edit: 'Edit targets / replace',
    add: 'Add exercise',
    superset: 'Superset',
    supersetDescription: 'Link this exercise with a neighboring exercise, or break the current superset.',
    dissolve: 'Break superset',
    linkWith: 'Link with {name}',
    supersetLinked: 'Superset updated.',
    supersetDissolved: 'Superset removed.',
    remove: 'Remove exercise',
    removeTitle: 'Remove this exercise?',
    removeDescription: 'This removes the exercise from the programmed workout. Exercises with logged sets cannot be removed during the session.',
    removing: 'Removing...',
    removed: 'Exercise removed.',
    cancel: 'Cancel',
    saveError: 'Could not update the workout.',
  },
  valuePicker: {
