export const session = {
  ...
  exerciseActions: {
    ...
    superset: 'Superset',
    supersetDescription:
      'Link this exercise with a neighboring exercise, or break the current superset.',
    ...
    removeDescription:
      'This removes the exercise from the programmed workout. Exercises with logged sets cannot be removed during the session.',
    removing: 'Removing...',
