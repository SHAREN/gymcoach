...
/**
 * Recomputes an exercise goal from the durable set history after a historical
 * correction. This intentionally handles both directions: a newly added or
 * edited historical row can achieve a goal, while deleting/editing the row
 * that achieved it can clear or move achievedAt.
 */
