...
export const PREFERENCES_CHANGED_EVENT = 'gymcoach:preferences-changed';
...
export interface UserPreferences {
  ...
  // Legacy single rep-max preference kept for backward compatibility with existing localStorage.
  rmDisplay: '1RM' | '10RM';
  // Calculated columns shown around the strength set table.
