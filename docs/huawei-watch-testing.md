...
targets. Production Wear Engine transport, Lite file storage, DevEco build and
Previewer execution are now implemented or verified locally. Huawei service
approval, App ID, `DEVICE_MANAGER`, HAP signing and physical-watch behavior
remain blocked.
